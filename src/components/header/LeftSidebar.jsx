...
const LeftSidebar = () => {
  ...
  return (
    ...
    >
        ...
        <li className="mb-[10px] flex justify-center">
          <Link href="/" className='flex items-center justify-start'>
              <span className="icon min-w-[80px] flex justify-center">
                <img src="/images/logo-1.webp" alt="logo-icon" className="w-[50px]" />
              </span>
                <span className="title whitespace-nowrap"><img src="/images/logo-2.webp" alt="logo" /></span> 
          </Link>
        </li>
      ...
      {/* Toggle Button */}
      <button
        className="absolute bottom-5 left-[15px] bg-[#2b6a83] w-[40px] h-[40px] bg-[#13131d] rounded-full border border-white flex items-center justify-center cursor-pointer group"
